...
<div class="face-one-intro">
    <div class="face-one-intro-title">onface.vue</div>
    ...
    <div class="face-one-intro-tool">
        <a href="https://onface.github.io/vue" class="face-one-intro-btn face-one-intro-btn--primary mr-online-hide" >在线文档</a>
        <!-- MARKRUN-HTML
            <a href="./doc/intro.md" class="face-one-intro-btn face-one-intro-btn--primary">指引</a>
            <a href="http://github.com/onface/vue" class="face-one-intro-btn">GITHUB</a>
        -->
    </div>
</div>
...
<div style="text-align:center;" >
    <a href="https://travis-ci.org/onface/vue" style="text-decoration: none;" >
        <img alt="Build Status" src="https://api.travis-ci.org/onface/vue.svg?branch=master" />
    </a>
    <a href="https://npmjs.org/package/onface.vue"  style="text-decoration: none;" >
        <img alt="NPM version" src="https://img.shields.io/npm/v/onface.vue.svg?style=flat" />
    </a>
    <a href="https://npmjs.org/package/onface.vue"  style="text-decoration: none;" >
        <img alt="NPM downloads" src="https://img.shields.io/npm/dm/onface.vue.svg?style=flat" />
    </a>
</div>


<a href="https://saucelabs.com/u/onface-vue" >
    <img alt="Saucelabs Tests" style="display:block;margin-left:auto;margin-right:auto;" src="https://saucelabs.com/browser-matrix/onface-vue.svg" >
</a>
